...
@subclass("esri.widgets.PopupInfo")
  class PopupInfo extends declared(Widget) {
    ...
    render() {
        return (
    <div afterCreate={this._addInfoPanel} class="popupInfo">
    	<div tabindex="0" style="height:100%;"  afterCreate={this._addContentPanel}>
            <div >
                <div id="feature_content"></div>
            </div>
        </div>
        <div id="popupInfo_Footer" style="display:none;">
            <table width='100%' role='presentation' class='popupInfo_Footer'>
                <tr>
                    <td width='33%'>
                        <span class='popupInfo_locator-Score'>{i18n.popupInfo.Score} <span afterCreate={this._addScore}></span></span>
                    </td>
                    ...
                    <td width='33%' style='text-align:right;'>
                        <a class='popupInfo_locator-Copy' tabindex="0" title={i18n.geoCoding.CopyToClipboard}>{i18n.geoCoding.Copy}</a>
                    </td>
                </tr>
            </table>
        </div>
