...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/support/widget"], function (require, exports, __extends, __decorate, decorators_1, Widget, widget_1) {
    "use strict";
    var AddressManagemet = /** @class */ (function (_super) {
        __extends(AddressManagemet, _super);
        // @property()
        // @renderable()
        ...
        AddressManagemet.prototype.render = function () {
            return (widget_1.tsx("div", { afterCreate: this._addAddressManagemet }));
        };
        __decorate([
            decorators_1.property()
        ], AddressManagemet.prototype, "mainView", void 0);
        AddressManagemet = __decorate([
            decorators_1.subclass("esri.widgets.AddressManagemet")
        ], AddressManagemet);
        return AddressManagemet;
